...
<header class="navbar navbar-expand-lg">
  <nav class="container py-2 border-bottom">
    <a href="{{ LaravelLocalization::getLocalizedURL($currentLocale, route('home')) }}" class="navbar-brand"><img
        src="{{ mix('images/logo.png') }}" height="40px" alt=""></a>
            ...
            <li>
              <a href="{{ LaravelLocalization::getLocalizedURL($localeCode, null, [], true) }}" rel="alternate"
                ...
                <img src="{{ LocalizationHelper::getPathToLocaleFlag($localeCode) }}"
                  alt="{{ LocalizationHelper::normalizeNativeLanguageName($language) }}" class="mr-1" width="24">
