    ...
    <nav class="navbar navbar-expand-md navbar-light fixed-top bg-white border-bottom">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link text-info" target="_blank"
            ...
            <ul class="navbar-nav ml-auto">
                ...
                @else
                    <li class="nav-item dropdown d-none d-md-block">
                        ...
                        <div class="dropdown-menu x-z-index-dropdown dropdown-menu-right"
                    ...
                    <div class="d-md-none">
                        ...
                        <li class="nav-item">
                            <a class="nav-link text-secondary" href="{{ route('logout') }}" data-method="post"
                               rel="nofollow">
                                {{ __('layout.nav.logout') }}
                            </a>
                        </li>
            ...
            <ul class="navbar-nav">
                <li class="nav-item dropdown">
                    <hr class="d-md-none">
                    <a class="nav-link dropdown-toggle" id="dropdownFlagButton" data-toggle="dropdown"
                       aria-haspopup="true" aria-expanded="false" href="#">
                        <img src="{{ getPathToLocaleFlag($currentLocale) }}"
                             alt="{{ getNativeLanguageName($currentLocale) }}" class="mr-1" width="24">
                    ...
                    <div class="dropdown-menu dropdown-menu-right x-min-w-0" aria-labelledby="dropdownFlagButton">
                        @foreach($otherLocales as $localeCode => ['native' => $language])
                            <a rel="alternate" class="dropdown-item pl-2 py-0" hreflang="{{ $localeCode }}"
                               href="{{ LaravelLocalization::getLocalizedURL($localeCode, null, [], true) }}">
                                <img src="{{ getPathToLocaleFlag($localeCode) }}"
                                     alt="{{ normalizeNativeLanguageName($language) }}" class="mr-1" width="24">
