...
return [
    ...
    'description' => [
        ...
        "Modify gcd-terms to use pseudoremainder-terms, and verify that greatest-common-divisor now produces an answer with integer coefficients on the example in exercise ",
        '2' =>
        ...
        '4' =>
        "Compute the GCD of the numerator and denominator, using the version of gcd-terms from exercise ",
        '5' =>
