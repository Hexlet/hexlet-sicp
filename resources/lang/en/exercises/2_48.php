...
return [
    'title' => 'Representation of segments using vectors.',
    'description' => [
        '1' =>
        ...
        '2' =>
        " to define a representation for segments with a constructor make-segment and selectors start-segment and end-segment.",
    ],
];
