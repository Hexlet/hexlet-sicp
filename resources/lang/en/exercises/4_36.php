...
return [
    'title' => 'Generate arbitrary Pythagorean triples',
    'description' => [
        '1' => "Exercise ",
        '2' => " discussed how to generate the stream of all Pythagorean triples, with no upper bound on the size " .
        "of the integers to be searched. Explain why simply replacing an-integer-between by " .
