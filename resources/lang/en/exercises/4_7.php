...
return [
    ...
    'description' => [
        ...
        "write a procedure let*->nested-lets that performs this transformation. If we have already implemented let (exercise ",
        '3' => ") and we want to extend the evaluator to handle let*, is it sufficient to add a clause to eval whose action is",
        '4' => "or must we explicitly expand let* in terms of non-derived expressions?",
    ],
];
