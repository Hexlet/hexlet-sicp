...
return [
    ...
    'description' => [
        ...
        "Furthermore, each employee's record is itself a set (structured differently from division to division) that contains information keyed under identifiers such as ",
        '3' =>
        " and ",
        '4' =>
        ". In particular:",
