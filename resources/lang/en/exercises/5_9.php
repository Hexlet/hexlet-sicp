...
return [
    'title' => "Using operations to registers and constants only",
    'description' => "The treatment of machine operations above permits them to operate on labels as well as " .
