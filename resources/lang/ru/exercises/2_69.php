...
return [
    ...
    'description' => [
        ...
        "Вам нужно написать процедуру successive-merge, которая при помощи make-code-tree сливает наиболее легкие элементы множества, пока не останется только один элемент, который и представляет собой требуемое дерево Хаффмана. " .
