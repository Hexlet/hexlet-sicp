...
return [
    ...
    'description' => [
        ...
        "а a — произвольное положительное целое число, меньшее n, то a в n−1ой степени равняется 1 по модулю n. " .
        ...
        "и используйте ее для реализации теста Миллера–Рабина с помощью процедуры miller-rabin-test, аналогичной fermat-test. " .
