...
return [
    ...
    'description' => [
        ...
        "Более того, каждая запись сама по себе — набор сведений (в разных подразделениях устроенный по-разному), в котором информация индексируется метками вроде ",
        '3' =>
        " (адрес) или ",
        '4' =>
        " (зарплата). В частности: ",
        '5' =>
        "а. Для главного офиса реализуйте процедуру ",
        '6' =>
        ...
        '7' =>
        "б. Для главного офиса реализуйте процедуру ",
        '8' =>
        ...
        '9' =>
        "в. Для главного офиса напишите процедуру ",
        '10' =>
